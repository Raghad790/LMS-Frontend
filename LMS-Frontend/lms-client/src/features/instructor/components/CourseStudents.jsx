...
const CourseStudents = () => {
  ...
  const filteredAndSortedEnrollments = useMemo(() => {
    ...
    if (filterConfig.completed !== "all") {
      ...
      result = result.filter(
        (enrollment) => enrollment.completed === isCompleted
      );
    }
                ...
                <div className={styles.filterOptions}>
                  <button
                    className={`${styles.filterOption} ${
                      filterConfig.completed === "all" ? styles.active : ""
                    }`}
                    onClick={() =>
                      setFilterConfig({ ...filterConfig, completed: "all" })
                    }
                  >
                    All
                  </button>
                  <button
                    className={`${styles.filterOption} ${
                      filterConfig.completed === "completed"
                        ? styles.active
                        : ""
                    }`}
                    onClick={() =>
                  ...
                  <button
                    className={`${styles.filterOption} ${
                      filterConfig.completed === "inprogress"
                        ? styles.active
                        : ""
                    }`}
                    onClick={() =>
